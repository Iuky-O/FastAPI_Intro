...
class AnaliseHabitoVida(Base):
    ...
    predicao_id = Column(Integer, ForeignKey('predicoes_risco_habito_vida.predicao_id'), nullable=False)
    predicao = relationship("PredicaoHabitoVida", back_populates="analises")