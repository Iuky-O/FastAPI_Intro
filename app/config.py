...
settings = Dynaconf(                                        #criando o objeto settings de Dynaconf
    ...
    settings_file=[".secrets.toml"],                        #dizendo quais os arquivo de configurações sensíveis
    ...
    load_dotenv=False,                                      #Dizendo para não carregar automaticamente arquivos .env
)